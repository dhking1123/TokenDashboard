...
a = Analysis([str(root / 'src/usage-dashboard.py')], pathex=[], binaries=[], datas=[], hiddenimports=[], hookspath=[], hooksconfig={}, runtime_hooks=[], excludes=[], noarchive=False)
...
pyz = PYZ(a.pure)
exe = EXE(pyz, a.scripts, a.binaries, a.datas, [], name='CodexUsageDashboard', console=False, icon=[str(root / 'assets/battery.ico')])
